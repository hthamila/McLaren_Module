...
FROM pce_qe16_slp_prd_stg.prmradmp.intermediate_stg_rev_bdgt_actual
GROUP BY
    fcy_nm,
    in_or_out_patient_ind,
    service_month,
...
ON
    ...
    select distinct fcy_nm, cdr_dt, in_or_out_patient_ind, null dept_grp_2, null daily_budget_amount
        from pce_qe16_slp_prd_stg..intermediate_stg_rev_bdgt
        join cdr_dim
   ...
   FROM pce_qe16_slp_prd_stg.prmradmp.intermediate_stg_rev_bdgt_actual_missing
