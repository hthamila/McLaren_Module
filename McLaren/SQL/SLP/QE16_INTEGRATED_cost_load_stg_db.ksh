...
v_crt_stm_2='1 as cnt from pce_qe16_slp_prd_stg..intermediate_encntr_cst_fct group by fcy_nm, encntr_num distribute on (fcy_nm, encntr_num);'
...
echo -e "${v_drp_stg} \n${v_crt_stm_1}\n " >  /ds_data1/${v_project}/sql/QE16/SLP/encntr_cost_anl_fct_stg_db.sql

nzsql -h ${v_nzHost} -u ${v_nzUsr} -d pce_qe16_slp_${env}_stg -r -t -f /ds_data1/${v_project}/sql/QE16/SLP/QE16_INTEGRATED_att_gen.sql >> /ds_data1/${v_project}/sql/QE16/SLP/encntr_cost_anl_fct_stg_db.sql
        if [ $? -ne 0 ]; then
...
echo -e  "\n${v_crt_stm_2} \n\n${v_chk_prv} \n${v_alt_bkp} \n${v_alt_stage}" >> /ds_data1/${v_project}/sql/QE16/SLP/encntr_cost_anl_fct_stg_db.sql

#Execute now the SQL for creation of Fact Table
nzsql -h ${v_nzHost} -u ${v_nzUsr} -d pce_qe16_slp_${env}_stg -r -t -f /ds_data1/${v_project}/sql/QE16/SLP/encntr_cost_anl_fct_stg_db.sql
