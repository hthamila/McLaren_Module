...
CREATE TABLE prd_encntr_oncology_anl_fct AS SELECT *,now() as rcrd_isrt_ts, hash8(fcy_nm || '-' || encntr_num) as fcy_encntr_hashkey FROM intermediate_encntr_oncology_anl_fct;
