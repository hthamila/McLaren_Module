...
,CASE WHEN spl_dim.persp_clncl_smy_descr = 'SURGERY TIME' AND 
UPPER(spl_dim.persp_clncl_dtl_descr) <> 'OR MINOR FLAT RATE' AND UPPER(spl_dim.persp_clncl_dtl_descr) IN ('OR MINOR 1 HR','OR MAJOR 1 HR','ROBOTIC OR TIME 1 HOUR') THEN 
   ROUND(stage_chrg_fct_temp.quantity * spl_dim.spl_unit_cnvr * spl_dim.persp_clncl_dtl_unit,2) 
   ELSE 
