...
--CODE Change : Adding stage_stage_spl_dim to fix the Lansing encounters with Charge Code but SPL Code is NULL issue 
DROP TABLE stage_spl_dim IF EXISTS;
CREATE TABLE stage_spl_dim as
...
,stage_chrg_fct_temp.*
--,stage_spl_dim.cdm_cd
--,stage_spl_dim.cdm_strt_cdr_dk
--,stage_spl_dim.cdm_strt_dt
--,stage_spl_dim.cdm_end_cdr_dk
--,stage_spl_dim.cdm_end_dt
--,stage_spl_dim.cdm_descr
,stage_spl_dim.persp_clncl_dtl_pcd_cd_v10
,stage_spl_dim.persp_clncl_dtl_pcd_descr_v10
,stage_spl_dim.spl_unit_cnvr
,stage_spl_dim.persp_clncl_dtl_cd
,stage_spl_dim.persp_clncl_dtl_descr
,stage_spl_dim.persp_clncl_dtl_unit
,stage_spl_dim.persp_clncl_smy_cd
,stage_spl_dim.persp_clncl_smy_descr
,stage_spl_dim.persp_clncl_std_dept_cd_v10
,stage_spl_dim.persp_clncl_std_dept_descr_v10
,stage_spl_dim.persp_clncl_std_dept_v10_rollup_cgy_cd
,stage_spl_dim.persp_clncl_std_dept_v10_rollup_cgy_descr
,stage_spl_dim.persp_clncl_dtl_spl_modfr_cd
,stage_spl_dim.persp_clncl_dtl_spl_modfr_descr
...
,CASE WHEN stage_spl_dim.persp_clncl_smy_descr = 'SURGERY TIME' AND 
UPPER(stage_spl_dim.persp_clncl_dtl_descr) <> 'OR MINOR FLAT RATE' AND UPPER(stage_spl_dim.persp_clncl_dtl_descr) IN ('OR MINOR 1 HR','OR MAJOR 1 HR','ROBOTIC OR TIME 1 HOUR') THEN 
   ROUND(stage_chrg_fct_temp.quantity * stage_spl_dim.spl_unit_cnvr * stage_spl_dim.persp_clncl_dtl_unit,2) 
   ELSE 
...
LEFT JOIN prmretlp.stage_spl_dim on stage_chrg_fct_temp.charge_code=stage_spl_dim.cdm_cd and stage_chrg_fct_temp.fcy_num=stage_spl_dim.fcy_num
...
--		 INNER JOIN temp_dschrg_inpatient ON temp_dschrg_inpatient.patient_id = ZOOM.patient_id 
		 INNER JOIN pce_qe16_slp_prd_dm..stage_spl_dim SP 
