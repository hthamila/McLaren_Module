...
------------------------------------------------------QA Attributes------------------------------------------------------------------------------------------------------------------------------------------
  --select * from pce_qe16_prd..tmp_qadv where encntr_num in ('000201144185','000201155559', '000201175243','000201175448');
--    select * from pce_qe16_prd_qadv..encntr where encntr_num in ('000201144185');
--	select distinct * from pce_qe16_prd.prmretlp.stg_encntr_qs_anl_fct_vw where encntr_num in ('000201144185','000201155559', '000201175243','000201175448');

DROP TABLE pce_qe16_prd..dgns_dim_slp if exists; 
create temp table pce_qe16_prd..dgns_dim_slp as select * from pce_qe16_slp_prd_dm..dgns_dim ;

DROP TABLE pce_qe16_prd.. pcd_dim_slp if exists; 
create temp table pce_qe16_prd..pcd_dim_slp as select * from pce_qe16_slp_prd_dm..pcd_dim ;
...
left outer join pce_qe16_prd..dgns_dim_slp dr on ef.icd10_diag_code = dr.dgns_cd AND dr.dgns_icd_ver =  'ICD10'
left outer join pce_qe16_prd..pcd_dim_slp procd on ef.icd10_proc_code = procd.icd_pcd_cd AND procd.icd_ver = 'ICD10'
...
SELECT distinct hf.fcy_nm,
hf.fcy_num,
max(add_months(date('06/01/2019'),12)) as rpt_dt,
sum(events_cnt) as harm_events_cnt
FROM pce_qe16_prd..stg_harm_events_fct hf
left join tmp_max_dschrg_dt tmd on hf.join_key=tmd.join_key
where  HF.event_dt between '07/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),12)
and hf.fcy_nm ='McLaren Greater Lansing'
group by 1,2
...
SELECT distinct hf.fcy_nm,
hf.fcy_num,
max(add_months(date('06/01/2019'),13)) as rpt_dt,
sum(events_cnt) as harm_events_cnt
FROM pce_qe16_prd..stg_harm_events_fct hf
left join tmp_max_dschrg_dt tmd on hf.join_key=tmd.join_key
where  HF.event_dt between '08/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),13)
and hf.fcy_nm ='McLaren Greater Lansing'
group by 1,2
...
SELECT distinct hf.fcy_nm,
hf.fcy_num,
max(add_months(date('06/01/2019'),14)) as rpt_dt,
sum(events_cnt) as harm_events_cnt
FROM pce_qe16_prd..stg_harm_events_fct hf
left join tmp_max_dschrg_dt tmd on hf.join_key=tmd.join_key
where  HF.event_dt between '09/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),14)
and hf.fcy_nm ='McLaren Greater Lansing'
group by 1,2
...
SELECT distinct hf.fcy_nm,
hf.fcy_num,
max(add_months(date('06/01/2019'),15)) as rpt_dt,
sum(events_cnt) as harm_events_cnt
FROM pce_qe16_prd..stg_harm_events_fct hf
left join tmp_max_dschrg_dt tmd on hf.join_key=tmd.join_key
where  HF.event_dt between '10/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),15)
and hf.fcy_nm ='McLaren Greater Lansing'
group by 1,2
);
...
select * FROm tmp_max_dschrg_dt;
--Test
select fcy_num, fcy_nm, count(*) from pce_qe16_prd..stg_encntr_qs_anl_fct_vw ef GROUP BY 1,2; 

select date_trunc('month', dschrg_dt), count(*) from pce_qe16_prd..stg_encntr_qs_anl_fct_vw ef WHERE 
dschrg_Dt between '2019-05-01' AND '2020-04-30' AND 
fcy_num = 'MI5020'
GROUP BY 1; 
...
FROM pce_qe16_prd..stg_zero_event_fct zf
left join tmp_max_dschrg_dt tmd on join_key= tmd.join_key
where  ZF.event_dt between '07/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),12)
and ZF.fcy_nm ='McLaren Greater Lansing'
group by 1,2
...
FROM pce_qe16_prd..stg_zero_event_fct zf
left join tmp_max_dschrg_dt tmd on join_key= tmd.join_key
where  ZF.event_dt between '08/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),13)
and ZF.fcy_nm ='McLaren Greater Lansing'
group by 1,2
...
FROM pce_qe16_prd..stg_zero_event_fct zf
left join tmp_max_dschrg_dt tmd on join_key= tmd.join_key
where  ZF.event_dt between '09/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),14)
and ZF.fcy_nm ='McLaren Greater Lansing'
group by 1,2
...
FROM pce_qe16_prd..stg_zero_event_fct zf
left join tmp_max_dschrg_dt tmd on join_key= tmd.join_key
where  ZF.event_dt between '10/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),15)
and ZF.fcy_nm ='McLaren Greater Lansing'
group by 1,2
...
--select * from encntr_qs_anl_fct_vw LIMIT 100 ;
select COUNT(*) from pce_qe16_prd..tmp_mort; --227364  --233208  -- 288282  -- 275960
--select COUNT(*)  from pce_qe16_prd..tmp_mort X  WHERE fcy_nm = 'McLaren Greater Lansing' 
--AND X.dschrg_dt between '2019-04-01' AND '2020-03-31';
...
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null
 ...
 select tm.fcy_nm,tm.fcy_num,
 max(date_trunc('month',add_months(date('06/01/2019'),10))) as rpt_dt,
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null 
 when tm.mrtly_excl_ind=1  then mrtly_cnt_w_excl
 else null
 end)) as mort_obs_rt,
...
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null
 ...
 select tm.fcy_nm,tm.fcy_num,
 max(date_trunc('month',add_months(date('06/01/2019'),11))) as rpt_dt,
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null 
 when tm.mrtly_excl_ind=1  then mrtly_cnt_w_excl
 else null
 end)) as mort_obs_rt,
...
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null
 ...
 --Added on Sept 8th 2020
    UNION
 
 select tm.fcy_nm,tm.fcy_num,
 max(date_trunc('month',add_months(date('06/01/2019'),12))) as rpt_dt,
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null 
 when tm.mrtly_excl_ind=1  then mrtly_cnt_w_excl
 else null
 end)) as mort_obs_rt,
...
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null
 ...
 from tmp_mort tm
 left join tmp_max_dschrg_dt tmd on tm.join_key=tmd.join_key
 where tm.dschrg_dt between '07/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),12)
 and fcy_nm = 'McLaren Greater Lansing'
 group by 1,2
 ...
 select tm.fcy_nm,tm.fcy_num,
 max(date_trunc('month',add_months(date('06/01/2019'),13))) as rpt_dt,
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null 
 when tm.mrtly_excl_ind=1  then mrtly_cnt_w_excl
 else null
 end)) as mort_obs_rt,
...
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null
 ...
 from tmp_mort tm
 left join tmp_max_dschrg_dt tmd on tm.join_key=tmd.join_key
 where tm.dschrg_dt between '08/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),13)
 and fcy_nm = 'McLaren Greater Lansing'
 group by 1,2
 ...
 select tm.fcy_nm,tm.fcy_num,
 max(date_trunc('month',add_months(date('06/01/2019'),14))) as rpt_dt,
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null 
 when tm.mrtly_excl_ind=1  then mrtly_cnt_w_excl
 else null
 end)) as mort_obs_rt,
...
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null
 ...
 from tmp_mort tm
 left join tmp_max_dschrg_dt tmd on tm.join_key=tmd.join_key
 where tm.dschrg_dt between '09/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),14)
 and fcy_nm = 'McLaren Greater Lansing'
 group by 1,2
 ...
 select tm.fcy_nm,tm.fcy_num,
 max(date_trunc('month',add_months(date('06/01/2019'),15))) as rpt_dt,
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null 
 when tm.mrtly_excl_ind=1  then mrtly_cnt_w_excl
 else null
 end)) as mort_obs_rt,
...
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null
 ...
 from tmp_mort tm
 left join tmp_max_dschrg_dt tmd on tm.join_key=tmd.join_key
 where tm.dschrg_dt between '10/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),15)
 and fcy_nm = 'McLaren Greater Lansing'
 group by 1,2
 ;
 
 select * from pce_qe16_prd..stg_tmp_mrtly_ind;

-----Rest Of the SQLS
--CODE CHANGE: 08/24/2020 MLH-579 Excluding COVID _cases 
drop table pce_qe16_prd..stg_tmp_mrtly_ind_wo_covid if exists;
 create table pce_qe16_prd..stg_tmp_mrtly_ind_wo_covid as 
 select tm.fcy_nm,tm.fcy_num,
 max(date_trunc('month',tmd.max_dt)) as rpt_dt,
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null 
 when tm.mrtly_excl_ind=1  then mrtly_cnt_w_excl
...
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null
 ...
 left join tmp_max_dschrg_dt tmd on tm.join_key=tmd.join_key
 where tm.dschrg_dt between add_months((select date_trunc('month',max_dt) from tmp_max_dschrg_dt ),-11) and (select last_day(max_dt) from tmp_max_dschrg_dt)
 and fcy_nm <>'McLaren Greater Lansing' and non_covid_case_ind = 1 
 group by 1,2
...
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null
 ...
 and fcy_nm = 'McLaren Greater Lansing'    and non_covid_case_ind = 1 
 group by 1,2
 -- Added Sept  8th 20202 since Lansing Data is not populating
   UNION
...
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null
 ...
 group by 1,2
  ...
  -- Added 10/11/2020 since Lansing Data is not populating
   UNION
...
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null
 ...
 group by 1,2
   ...
   -- Added 11/08/2020 since Lansing Data is not populating
   UNION
...
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null
 ...
 group by 1,2
    ...
    -- Added 12/07/2020 since Lansing Data is not populating
   UNION
...
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null
 ...
 drop table pce_qe16_prd..stg_tmp_sep_mrtly_ind_wo_covid if exists;
 create table pce_qe16_prd..stg_tmp_sep_mrtly_ind_wo_covid as
 (select tm.fcy_nm,
 tm.fcy_num,
 max(date_trunc('month',tmd.max_dt)) as rpt_dt,
(AVG( case when tm.mrtly_outc_case_w_excl=0 then null 
...
-- select fcy_nm, date_trunc('month',dschrg_dt), COUNT(*) FROM pce_qe16_prd..tmp_readm 
-- WHERE date(dschrg_dt) between '2019-07-01' and '2020-06-30' AND fcy_nm  ='McLaren Port Huron Hospital'
-- GROUP BY 1,2;
-- 
-- 
-- --
...
-- )) as readm_expc_rt
--
-- from tmp_readm tr WHERE date(dschrg_dt) between '2020-02-01' and '2020-02-29'
-- AND fcy_nm  ='McLaren Port Huron Hospital'
--  GROUP BY 1,2;
--  
--  select * from pce_qe16_prd..tmp_readm where date(dschrg_dt) = '2020-02-23'
--   AND fcy_nm  ='McLaren Port Huron Hospital'
--   AND encntr_num IN ('PH1501203574','PH1501203525');
----   
--   select encntr_num, prs_readm_30day_rsk_out_case_cnt FROM 
--   pce_qe16_prd..stg_encntr_qs_anl_fct_vw
--   WHERE encntr_num IN ('PH1501203574','PH1501203525');
----   
--     select encntr_num, prs_readm_30day_rsk_out_case_cnt FROM 
--   pce_qe16_prd..encntr_qs_anl_fct_vw
--   WHERE encntr_num IN ('PH1501203574','PH1501203525');
--   
--      select * FROM 
--   pce_qe16_prd..encntr_qs_anl_fct_vw
...
1 as join_key
FROM pce_qe16_prd..stg_encntr_qs_anl_fct_vw ef
where ef.stnd_ptnt_type_cd = '08' AND EF.readm_excl_ind =1 
group by 1,2,3,4,5,6
);
-->
 select tr.fcy_nm,
...
(SUM( case when tr.readm_outc_case=0 then null
 ...
 date(dschrg_dt) between '2019-08-01' and '2020-07-31' AND fcy_nm  ='McLaren Central Michigan' --'McLaren Bay Region'  --'McLaren Port Huron Hospital'
  ...
  select * from pce_qe16_prd..tmp_qadv where encntr_num in ('000201144185');
    select * from pce_qe16_prd_qadv..encntr where encntr_num in ('000201144185');
  
  select distinct fcy_nm from tmp_readm;
--  
--   select tr.fcy_nm,
-- date(dschrg_dt),
-- sum(tr.readm_outc_case) as readm_out_ct
-- from tmp_readm tr WHERE date(dschrg_dt) between '2020-01-01' and '2020-01-31' AND fcy_nm  ='McLaren Port Huron Hospital'
--  GROUP BY 1,2;
--  
-- select *
-- from tmp_readm tr 
-- WHERE date(dschrg_dt) = '2020-01-17'  AND fcy_nm  ='McLaren Port Huron Hospital'
-- --and '2020-01-31' 
-- ;
--  
--   select tr.fcy_nm,
-- COUNT(*)
-- from tmp_readm tr WHERE date(dschrg_dt) between '2019-07-01' and '2020-06-30' AND fcy_nm  ='McLaren Port Huron Hospital'
--  GROUP BY 1;
-->
...
(AVG( case when tr.readm_outc_case=0 then null
 ...
 from tmp_readm tr
 left join tmp_max_dschrg_dt tmd on tr.join_key=tmd.join_key
 where  tr.dschrg_dt between '07/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),12)
 and fcy_nm ='McLaren Greater Lansing'
 group by 1,2
...
(AVG( case when tr.readm_outc_case=0 then null
 ...
 from tmp_readm tr
 left join tmp_max_dschrg_dt tmd on tr.join_key=tmd.join_key
 where  tr.dschrg_dt between '08/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),13)
 and fcy_nm ='McLaren Greater Lansing'
 group by 1,2
  --Added on 11/11/2020
   UNION
...
(AVG( case when tr.readm_outc_case=0 then null
 ...
 from tmp_readm tr
 left join tmp_max_dschrg_dt tmd on tr.join_key=tmd.join_key
 where  tr.dschrg_dt between '09/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),14)
 and fcy_nm ='McLaren Greater Lansing'
 group by 1,2
...
(AVG( case when tr.readm_outc_case=0 then null
 ...
 from tmp_readm tr
 left join tmp_max_dschrg_dt tmd on tr.join_key=tmd.join_key
 where  tr.dschrg_dt between '10/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),15)
 and fcy_nm ='McLaren Greater Lansing'
 group by 1,2
 );
 ...
 drop table pce_qe16_prd..stg_tmp_readm_ind_wo_covid if exists;
 create table pce_qe16_prd..stg_tmp_readm_ind_wo_covid as 
  (select tr.fcy_nm,
 tr.fcy_num,
 max(date_trunc('month',tmd.max_dt)) as rpt_dt,
(AVG( case when tr.readm_outc_case=0 then null 
...
from tmp_lab_utlz tlu
left join tmp_max_dschrg_dt tmd on tlu.join_key=tmd.join_key
where tlu.dschrg_dt between '07/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),12)
 and tlu.fcy_nm = 'Lansing'
 group by 1,2
...
from tmp_lab_utlz tlu
left join tmp_max_dschrg_dt tmd on tlu.join_key=tmd.join_key
where tlu.dschrg_dt between '08/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),13)
 and tlu.fcy_nm = 'Lansing'
 group by 1,2
...
from tmp_lab_utlz tlu
left join tmp_max_dschrg_dt tmd on tlu.join_key=tmd.join_key
where tlu.dschrg_dt between '09/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),14)
 and tlu.fcy_nm = 'Lansing'
 group by 1,2
...
from tmp_lab_utlz tlu
left join tmp_max_dschrg_dt tmd on tlu.join_key=tmd.join_key
where tlu.dschrg_dt between '10/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),15)
 and tlu.fcy_nm = 'Lansing'
 group by 1,2
 );
 
 ----CODE CHANGE: 08/24/2020 MLH-579 Excluding COVID _cases 
 drop table pce_qe16_prd..stg_tmp_lab_utlz_fct_wo_covid if exists;
create  table pce_qe16_prd..stg_tmp_lab_utlz_fct_wo_covid as 
...
left join tmp_max_dschrg_dt tmd on tlu.join_key=tmd.join_key
where tlu.dschrg_dt between add_months((select date_trunc('month',max_dt) from tmp_max_dschrg_dt ),-11) and (select last_day(max_dt) from tmp_max_dschrg_dt)
 and tlu.fcy_nm <>'Lansing' and tlu.non_covid_case_ind=1
 group by 1,2
...
from tmp_sep_compl tsc
 left join tmp_max_dschrg_dt tmd on tsc.join_key=tmd.join_key
where tsc.dschrg_dt between '07/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),12)
and tsc.fcy_nm='Greater Lansing'
group by 1,2
...
from tmp_sep_compl tsc
 left join tmp_max_dschrg_dt tmd on tsc.join_key=tmd.join_key
where tsc.dschrg_dt between '08/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),13)
and tsc.fcy_nm='Greater Lansing'
group by 1,2
...
from tmp_sep_compl tsc
 left join tmp_max_dschrg_dt tmd on tsc.join_key=tmd.join_key
where tsc.dschrg_dt between '09/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),14)
and tsc.fcy_nm='Greater Lansing'
group by 1,2
...
from tmp_sep_compl tsc
 left join tmp_max_dschrg_dt tmd on tsc.join_key=tmd.join_key
where tsc.dschrg_dt between '10/01/2019' and add_months((select last_day(date('06/01/2019')) from tmp_max_dschrg_dt),15)
and tsc.fcy_nm='Greater Lansing'
group by 1,2
);
...
;create temp table  tmp_maxd as
  ...
  select * from tmp_sf LIMIT 100 ; 
 
 select * from pce_qe16_prd..ptnt_exrnc_pct_msr_fct where fcy_nm ='Central';
 
 select fcy_nm, sum(resp_cnt), sum(top_box_resp_cnt) from pce_qe16_prd..ptnt_exrnc_pct_msr_fct Z  WHERE DATE(Z.rprt_dt) = '2020-07-31' GROUP BY 1; 
...
--select * from pce_qe16_pressganey_prd_zoom..prgny_ptnt_exrnc_pct_dim where prgny_pct  IN  (9,10); 

select * from stg_ptnt_exrnc_pct_msr_fct;
...
FROM pce_qe16_prd..stg_ptnt_exrnc_pct_msr_fct pepm
...
--select * from pce_qe16_prd..stg_aco_mpp_msr_fct; 
...
select distinct clientname from pce_qe16_prd..ncdr_hsptl_fct_vw WHERE timeframecode= '2020Q2';
select * from pce_qe16_prd..ncdr_hsptl_fct_vw WHERE timeframecode= '2020Q2';
...
--select distinct fcy_nm , fcy_num from tmp_card_rehab_fct;
--
--select * from tmp_cardiac_rehab_fct WHERE fcy_nm like '%Bay%';
--select * From tmp_cardiac_rehab WHERE fcy_nm like '%Bay%';
--select * From stg_tmp_card_rehab_fct WHERE fcy_nm like '%Bay%';
...
----CODE CHANGE: Commented Srujan's Code 
--drop table pce_qe16_prd..stg_tmp_card_rehab_fct if exists;
--create  table pce_qe16_prd..stg_tmp_card_rehab_fct as 
--(select tcr.fcy_nm,
--tcr.fcy_num,
...
*/
 ...
 select date_trunc('month',max_dt) from tmp_max_dschrg_dt;
 
 select add_months((select last_day(max_dt) from tmp_max_dschrg_dt), -3); 
 
 select add_months((select date_trunc('month',max_dt) from tmp_max_dschrg_dt ),-12) , add_months((select last_day(max_dt) from tmp_max_dschrg_dt),-1);
 select add_months((select date_trunc('month',max_dt) from tmp_max_dschrg_dt ),-13) , add_months((select last_day(max_dt) from tmp_max_dschrg_dt),-2);
...
(case 
when tmi.fcy_num = 'MI2191' and round(max(tri.readm_obs_rt),3) > 0.133 then 0
when tmi.fcy_num = 'MI2191' and round(max(tri.readm_obs_rt),3)> 0.127 and round(max(tri.readm_obs_rt),3) <= 0.133 then 50
when tmi.fcy_num = 'MI2191' and round(max(tri.readm_obs_rt),3)> 0.124 and round(max(tri.readm_obs_rt),3) <= 0.127 then 75
when tmi.fcy_num = 'MI2191' and round(max(tri.readm_obs_rt),3)> 0.122 and round(max(tri.readm_obs_rt),3) <= 0.124 then 100
when tmi.fcy_num = 'MI2191' and round(max(tri.readm_obs_rt),3)> 0.119 and round(max(tri.readm_obs_rt),3) <= 0.122 then 125
when tmi.fcy_num = 'MI2191' and round(max(tri.readm_obs_rt),3)<=0.119 then 150

when tmi.fcy_num = 'MI2061' and round(max(tri.readm_obs_rt),3) > 0.075 then 0
when tmi.fcy_num = 'MI2061' and round(max(tri.readm_obs_rt),3)> 0.071 and round(max(tri.readm_obs_rt),3) <= 0.0745 then 50
when tmi.fcy_num = 'MI2061' and round(max(tri.readm_obs_rt),3)> 0.070 and round(max(tri.readm_obs_rt),3) <= 0.071 then 75
when tmi.fcy_num = 'MI2061' and round(max(tri.readm_obs_rt),3)> 0.068 and round(max(tri.readm_obs_rt),3) <= 0.070 then 100
when tmi.fcy_num = 'MI2061' and round(max(tri.readm_obs_rt),3)> 0.067 and round(max(tri.readm_obs_rt),3) <= 0.068 then 125
when tmi.fcy_num = 'MI2061' and round(max(tri.readm_obs_rt),3)<=0.067 then 150

when tmi.fcy_num = 'MI2302'  and round(max(tri.readm_obs_rt),3) > 0.140 then 0
when tmi.fcy_num = 'MI2302'  and round(max(tri.readm_obs_rt),3)> 0.133 and round(max(tri.readm_obs_rt),3) <= 0.140 then 50
when tmi.fcy_num = 'MI2302'  and round(max(tri.readm_obs_rt),3)> 0.130 and round(max(tri.readm_obs_rt),3) <= 0.133 then 75
when tmi.fcy_num = 'MI2302'  and round(max(tri.readm_obs_rt),3)> 0.128 and round(max(tri.readm_obs_rt),3) <= 0.130 then 100
when tmi.fcy_num = 'MI2302'  and round(max(tri.readm_obs_rt),3)> 0.125 and round(max(tri.readm_obs_rt),3) <= 0.128 then 125
when tmi.fcy_num = 'MI2302'  and round(max(tri.readm_obs_rt),3)<=0.125 then 150


when tmi.fcy_num = 'MI5020'  and round(max(tri.readm_obs_rt),3) > 0.112 then 0
when tmi.fcy_num = 'MI5020'  and round(max(tri.readm_obs_rt),3)> 0.107 and round(max(tri.readm_obs_rt),3) <= 0.112 then 50
...
when tmi.fcy_num = 'MI2001'  and round(max(tri.readm_obs_rt),3) > 0.113 then 0
when tmi.fcy_num = 'MI2001'  and round(max(tri.readm_obs_rt),3)> 0.108 and round(max(tri.readm_obs_rt),3) <= 0.113 then 50
when tmi.fcy_num = 'MI2001'  and round(max(tri.readm_obs_rt),3)> 0.106 and round(max(tri.readm_obs_rt),3) <= 0.108 then 75
when tmi.fcy_num = 'MI2001'  and round(max(tri.readm_obs_rt),3)> 0.104 and round(max(tri.readm_obs_rt),3) <= 0.106 then 100
when tmi.fcy_num = 'MI2001'  and round(max(tri.readm_obs_rt),3)> 0.102 and round(max(tri.readm_obs_rt),3) <= 0.104 then 125
when tmi.fcy_num = 'MI2001'  and round(max(tri.readm_obs_rt),3)<=0.102 then 150

when tmi.fcy_num = 'MI2048'  and round(max(tri.readm_obs_rt),3) > 0.131 then 0
when tmi.fcy_num = 'MI2048'  and round(max(tri.readm_obs_rt),3)> 0.125 and round(max(tri.readm_obs_rt),3) <= 0.131 then 50
when tmi.fcy_num = 'MI2048'  and round(max(tri.readm_obs_rt),3)> 0.123 and round(max(tri.readm_obs_rt),3) <= 0.125 then 75
when tmi.fcy_num = 'MI2048'  and round(max(tri.readm_obs_rt),3)> 0.1200 and round(max(tri.readm_obs_rt),3) <= 0.123 then 100
when tmi.fcy_num = 'MI2048'  and round(max(tri.readm_obs_rt),3)> 0.118 and round(max(tri.readm_obs_rt),3) <= 0.1200 then 125
when tmi.fcy_num = 'MI2048'  and round(max(tri.readm_obs_rt),3)<=0.118 then 150

when tmi.fcy_num = '637619'  and round(max(tri.readm_obs_rt),3) > 0.101 then 0
when tmi.fcy_num = '637619'  and round(max(tri.readm_obs_rt),3)> 0.0960 and round(max(tri.readm_obs_rt),3) <= 0.101 then 50
when tmi.fcy_num = '637619'  and round(max(tri.readm_obs_rt),3)> 0.094 and round(max(tri.readm_obs_rt),3) <= 0.0960 then 75
when tmi.fcy_num = '637619'  and round(max(tri.readm_obs_rt),3)> 0.092 and round(max(tri.readm_obs_rt),3) <= 0.094 then 100
when tmi.fcy_num = '637619'  and round(max(tri.readm_obs_rt),3)> 0.090 and round(max(tri.readm_obs_rt),3) <= 0.092 then 125
when tmi.fcy_num = '637619'  and round(max(tri.readm_obs_rt),3)<=0.090 then 150

when tmi.fcy_num = 'MI2055'  and round(max(tri.readm_obs_rt),3) > 0.12 then 0
when tmi.fcy_num = 'MI2055'  and round(max(tri.readm_obs_rt),3)> 0.114 and round(max(tri.readm_obs_rt),3) <= 0.12 then 50
when tmi.fcy_num = 'MI2055'  and round(max(tri.readm_obs_rt),3)> 0.112 and round(max(tri.readm_obs_rt),3) <= 0.1140 then 75
when tmi.fcy_num = 'MI2055'  and round(max(tri.readm_obs_rt),3)> 0.109 and round(max(tri.readm_obs_rt),3) <= 0.112 then 100
when tmi.fcy_num = 'MI2055'  and round(max(tri.readm_obs_rt),3)> 0.107 and round(max(tri.readm_obs_rt),3) <= 0.109 then 125
when tmi.fcy_num = 'MI2055'  and round(max(tri.readm_obs_rt),3)<=0.107 then 150

when tmi.fcy_num = '600816'  and round(max(tri.readm_obs_rt),3) > 0.134 then 0
when tmi.fcy_num = '600816'  and round(max(tri.readm_obs_rt),3)> 0.1280 and round(max(tri.readm_obs_rt),3) <= 0.134 then 50
when tmi.fcy_num = '600816'  and round(max(tri.readm_obs_rt),3)> 0.125 and round(max(tri.readm_obs_rt),3) <= 0.128 then 75
when tmi.fcy_num = '600816'  and round(max(tri.readm_obs_rt),3)> 0.123 and round(max(tri.readm_obs_rt),3) <= 0.125 then 100
when tmi.fcy_num = '600816'  and round(max(tri.readm_obs_rt),3)> 0.120 and round(max(tri.readm_obs_rt),3) <= 0.123 then 125
when tmi.fcy_num = '600816'  and round(max(tri.readm_obs_rt),3)<=0.120 then 150
...
(case 
when  round(max(tmi.mort_oe_rt),2) > 0.8 then 0
when  round(max(tmi.mort_oe_rt),2)  > 0.77 and round(max(tmi.mort_oe_rt),2)  <= 0.8 then 50
when  round(max(tmi.mort_oe_rt),2)  > 0.74 and round(max(tmi.mort_oe_rt),2)  <= 0.77 then 75
when  round(max(tmi.mort_oe_rt),2)  > 0.7 and  round(max(tmi.mort_oe_rt),2)  <= 0.74 then 100
...
(case 
when tmi.fcy_num = 'MI2191' and round(max(tlu.lab_utlz),2) > 4.91 then 0
when tmi.fcy_num = 'MI2191' and round(max(tlu.lab_utlz),2)> 4.68 and round(max(tlu.lab_utlz),2) <= 4.91 then 50
when tmi.fcy_num = 'MI2191' and round(max(tlu.lab_utlz),2)> 4.59 and round(max(tlu.lab_utlz),2) <= 4.68 then 75
when tmi.fcy_num = 'MI2191' and round(max(tlu.lab_utlz),2)> 4.49 and round(max(tlu.lab_utlz),2) <= 4.59 then 100
when tmi.fcy_num = 'MI2191' and round(max(tlu.lab_utlz),2)> 4.4 and round(max(tlu.lab_utlz),2) <= 4.49 then 125
when tmi.fcy_num = 'MI2191' and round(max(tlu.lab_utlz),2)<=4.4 then 150

when tmi.fcy_num = 'MI2061' and round(max(tlu.lab_utlz),2) > 5.88 then 0
when tmi.fcy_num = 'MI2061' and round(max(tlu.lab_utlz),2)> 5.60 and round(max(tlu.lab_utlz),2) <= 5.88 then 50
when tmi.fcy_num = 'MI2061' and round(max(tlu.lab_utlz),2)> 5.49 and round(max(tlu.lab_utlz),2) <= 5.60 then 75
when tmi.fcy_num = 'MI2061' and round(max(tlu.lab_utlz),2)> 5.38 and round(max(tlu.lab_utlz),2) <= 5.49 then 100
when tmi.fcy_num = 'MI2061' and round(max(tlu.lab_utlz),2)> 5.26 and round(max(tlu.lab_utlz),2) <= 5.38 then 125
when tmi.fcy_num = 'MI2061' and round(max(tlu.lab_utlz),2)<=5.26 then 150

when tmi.fcy_num = 'MI2302'  and round(max(tlu.lab_utlz),2) > 5.62 then 0
when tmi.fcy_num = 'MI2302'  and round(max(tlu.lab_utlz),2)> 5.35 and round(max(tlu.lab_utlz),2) <= 5.62 then 50
when tmi.fcy_num = 'MI2302'  and round(max(tlu.lab_utlz),2)> 5.24 and round(max(tlu.lab_utlz),2) <= 5.35 then 75
when tmi.fcy_num = 'MI2302'  and round(max(tlu.lab_utlz),2)> 5.14 and round(max(tlu.lab_utlz),2) <= 5.24 then 100
when tmi.fcy_num = 'MI2302'  and round(max(tlu.lab_utlz),2)> 5.03 and round(max(tlu.lab_utlz),2) <= 5.14 then 125
when tmi.fcy_num = 'MI2302'  and round(max(tlu.lab_utlz),2)<=5.03 then 150


when tmi.fcy_num = 'MI5020'  and round(max(tlu.lab_utlz),2) > 6.22 then 0
when tmi.fcy_num = 'MI5020'  and round(max(tlu.lab_utlz),2)> 5.92 and round(max(tlu.lab_utlz),2) <= 6.22 then 50
when tmi.fcy_num = 'MI5020'  and round(max(tlu.lab_utlz),2)> 5.8 and round(max(tlu.lab_utlz),2) <= 5.92 then 75
when tmi.fcy_num = 'MI5020'  and round(max(tlu.lab_utlz),2)> 5.68 and round(max(tlu.lab_utlz),2) <= 5.8 then 100
when tmi.fcy_num = 'MI5020'  and round(max(tlu.lab_utlz),2)> 5.56 and round(max(tlu.lab_utlz),2) <= 5.68 then 125
when tmi.fcy_num = 'MI5020'  and round(max(tlu.lab_utlz),2)<=5.56 then 150

when tmi.fcy_num = 'MI2001'  and round(max(tlu.lab_utlz),2) > 5.18 then 0
when tmi.fcy_num = 'MI2001'  and round(max(tlu.lab_utlz),2)> 4.93 and round(max(tlu.lab_utlz),2) <= 5.18 then 50
when tmi.fcy_num = 'MI2001'  and round(max(tlu.lab_utlz),2)> 4.83 and round(max(tlu.lab_utlz),2) <= 4.93 then 75
when tmi.fcy_num = 'MI2001'  and round(max(tlu.lab_utlz),2)> 4.73 and round(max(tlu.lab_utlz),2) <= 4.83 then 100
when tmi.fcy_num = 'MI2001'  and round(max(tlu.lab_utlz),2)> 4.63 and round(max(tlu.lab_utlz),2) <= 4.73 then 125
when tmi.fcy_num = 'MI2001'  and round(max(tlu.lab_utlz),2)<=4.63 then 150

when tmi.fcy_num = 'MI2048'  and round(max(tlu.lab_utlz),2) > 7.02 then 0
when tmi.fcy_num = 'MI2048'  and round(max(tlu.lab_utlz),2)> 6.69 and round(max(tlu.lab_utlz),2) <= 7.02 then 50
when tmi.fcy_num = 'MI2048'  and round(max(tlu.lab_utlz),2)> 6.56 and round(max(tlu.lab_utlz),2) <= 6.69 then 75
when tmi.fcy_num = 'MI2048'  and round(max(tlu.lab_utlz),2)> 6.42 and round(max(tlu.lab_utlz),2) <= 6.56 then 100
when tmi.fcy_num = 'MI2048'  and round(max(tlu.lab_utlz),2)> 6.29 and round(max(tlu.lab_utlz),2) <= 6.42 then 125
when tmi.fcy_num = 'MI2048'  and round(max(tlu.lab_utlz),2)<= 6.29 then 150
--
when tmi.fcy_num = '637619'  and round(max(tlu.lab_utlz),2) > 6.97 then 0
when tmi.fcy_num = '637619'  and round(max(tlu.lab_utlz),2)> 6.64 and round(max(tlu.lab_utlz),2) <= 6.97 then 50
when tmi.fcy_num = '637619'  and round(max(tlu.lab_utlz),2)> 6.51 and round(max(tlu.lab_utlz),2) <= 6.64 then 75
when tmi.fcy_num = '637619'  and round(max(tlu.lab_utlz),2)> 6.37 and round(max(tlu.lab_utlz),2) <= 6.51 then 100
when tmi.fcy_num = '637619'  and round(max(tlu.lab_utlz),2)> 6.24 and round(max(tlu.lab_utlz),2) <= 6.37 then 125
when tmi.fcy_num = '637619'  and round(max(tlu.lab_utlz),2)<= 6.24 then 150

when tmi.fcy_num = 'MI2055'  and round(max(tlu.lab_utlz),2) > 4.92 then 0
when tmi.fcy_num = 'MI2055'  and round(max(tlu.lab_utlz),2)> 4.69 and round(max(tlu.lab_utlz),2) <= 4.92 then 50
when tmi.fcy_num = 'MI2055'  and round(max(tlu.lab_utlz),2)> 4.6 and round(max(tlu.lab_utlz),2) <= 4.69 then 75
when tmi.fcy_num = 'MI2055'  and round(max(tlu.lab_utlz),2)> 4.5 and round(max(tlu.lab_utlz),2) <= 4.6 then 100
when tmi.fcy_num = 'MI2055'  and round(max(tlu.lab_utlz),2)> 4.41 and round(max(tlu.lab_utlz),2) <= 4.5 then 125
when tmi.fcy_num = 'MI2055'  and round(max(tlu.lab_utlz),2)<=4.41 then 150

when tmi.fcy_num = '600816'  and round(max(tlu.lab_utlz),2) > 5.51 then 0
when tmi.fcy_num = '600816'  and round(max(tlu.lab_utlz),2)> 5.25 and round(max(tlu.lab_utlz),2) <= 5.51 then 50
when tmi.fcy_num = '600816'  and round(max(tlu.lab_utlz),2)> 5.15 and round(max(tlu.lab_utlz),2) <= 5.25 then 75
when tmi.fcy_num = '600816'  and round(max(tlu.lab_utlz),2)> 5.04 and round(max(tlu.lab_utlz),2) <= 5.15 then 100
when tmi.fcy_num = '600816'  and round(max(tlu.lab_utlz),2)> 4.94 and round(max(tlu.lab_utlz),2) <= 5.04 then 125
when tmi.fcy_num = '600816'  and round(max(tlu.lab_utlz),2)<=4.94 then 150
...
when tmi.fcy_num = 'MI5020'  and max(thef.harm_events_cnt) >50 then 0
when tmi.fcy_num = 'MI5020'  and max(thef.harm_events_cnt) > 47 and max(thef.harm_events_cnt) <= 50 then 50
when tmi.fcy_num = 'MI5020'  and max(thef.harm_events_cnt) > 41 and max(thef.harm_events_cnt) <= 47 then 75
when tmi.fcy_num = 'MI5020'  and max(thef.harm_events_cnt) > 38 and max(thef.harm_events_cnt) <= 41 then 100
when tmi.fcy_num = 'MI5020'  and max(thef.harm_events_cnt) > 35 and max(thef.harm_events_cnt) <= 38 then 125
when tmi.fcy_num = 'MI5020'  and max(thef.harm_events_cnt) <=35 then 150
...
(case 
when  max(ROUND(tzef.zero_events_rt,2)) < 0.75 then 0
when  max(ROUND(tzef.zero_events_rt,2)) >= 0.75 and max(ROUND(tzef.zero_events_rt,2)) < 0.82 then 50
when  max(ROUND(tzef.zero_events_rt,2)) >= 0.82 and max(ROUND(tzef.zero_events_rt,2)) < 0.86 then 75
when  max(ROUND(tzef.zero_events_rt,2)) >= 0.86 and max(ROUND(tzef.zero_events_rt,2)) < 0.9 then 100
when  max(ROUND(tzef.zero_events_rt,2)) >= 0.9 and  max(ROUND(tzef.zero_events_rt,2)) <= 0.95 then 125
when  max(ROUND(tzef.zero_events_rt,2)) >=0.95 then 150
else 0
end
...
+( nvl(ob_training_pts,0)*0.10)+(nvl(lab_utlz_pts,0)*0.1)+(nvl(prgny_pct_scor_pts,0)*0.05)+(nvl(cardiac_rehab_pts,0)*0.03)+(max(nvl(round(acof.mpp_scr),0))*0.08)   +(nvl(ptnt_exrnc_scor_pts,0)*0.03)) as weighted_pts,
...
left join pce_qe16_prd..stg_pqsd_cmplc_idnx_fct pcf on tmi.rpt_dt = date_trunc('month',pcf.end_of_month) and pcf.end_of_month <> pcf.first_of_month and tmi.fcy_num = pcf.fcy_num and pcf.msr_nm = 'Compl_R12M'
...
left join pce_qe16_prd..stg_aco_mpp_msr_fct acof on tmi.rpt_dt = date_trunc('month',acof.rpt_prd_end_dt) and tmi.fcy_num = acof.fcy_num
...
left join pce_qe16_prd..stg_mmg_ovrl_ptnt_exrnc_msr_fct tpep on tmi.rpt_dt = date_trunc('month',tpep.rprt_dt) and tmi.fcy_num = tpep.fcy_num
group by 1,2,3

 );
 
 SELECT * from pce_qe16_prd..stg_clncl_outc_scor_fct;
 
 -----> --CODE CHANGE: 08/24/2020 MLH-579 Excluding COVID _cases 
 drop table pce_qe16_prd..stg_clncl_outc_scor_fct_wo_covid if exists;
create  table pce_qe16_prd..stg_clncl_outc_scor_fct_wo_covid as 
(select distinct tmi.fcy_nm,
tmi.fcy_num,
tmi.rpt_dt,
max(tmi.mort_obs_rt) as mort_obs_rt, 
...
((nvl(mort_oe_pts,0)*0.1)+(nvl(comp_oe_rt_pts,0)*0.1)+(nvl(harm_zero_events_pts,0)*0.15)+(nvl(readm_obs_oe_pts,0)*0.15)+ (nvl(sep_mort_oe_pts,0)*0.055)+(nvl(sep_compliance_rt_pts,0)*0.055)
+( nvl(ob_training_pts,0)*0.10)+(nvl(lab_utlz_pts,0)*0.1)+(nvl(prgny_pct_scor_pts,0)*0.05)+(nvl(cardiac_rehab_pts,0)*0.03)
+(max(nvl(round(acof.mpp_scr),0))*0.08)   +(nvl(ptnt_exrnc_scor_pts,0)*0.03)) as weighted_pts,
...
from 
pce_qe16_prd..stg_tmp_mrtly_ind_wo_covid tmi
left join pce_qe16_prd..stg_pqsd_cmplc_idnx_fct pcf on tmi.rpt_dt = date_trunc('month',pcf.end_of_month) and pcf.end_of_month <> pcf.first_of_month and tmi.fcy_num = pcf.fcy_num and pcf.msr_nm = 'Compl_R12M'
left join pce_qe16_prd..stg_tmp_readm_ind_wo_covid tri on tmi.rpt_dt = tri.rpt_dt and tmi.fcy_num=tri.fcy_num
left join pce_qe16_prd..stg_tmp_lab_utlz_fct_wo_covid tlu on tmi.rpt_dt = date(tlu.rpt_dt) and tmi.fcy_num = tlu.fcy_num
left join pce_qe16_prd..stg_tmp_card_rehab_fct tcrf on tmi.rpt_dt = tcrf.rpt_dt and tmi.fcy_num = tcrf.fcy_num
left join pce_qe16_prd..stg_tmp_ob_trn_fct tot on tmi.rpt_dt = tot.rpt_dt and tmi.fcy_num = tot.fcy_num
left join pce_qe16_prd..stg_tmp_sep_mrtly_ind_wo_covid tsm on tmi.rpt_dt = tsm.rpt_dt and tmi.fcy_num = tsm.fcy_num
left join pce_qe16_prd..stg_tmp_sep_compl_fct tscf on tmi.rpt_dt = tscf.rpt_dt and tmi.fcy_num = tscf.fcy_num
left join pce_qe16_prd..stg_aco_mpp_msr_fct acof on tmi.rpt_dt = date_trunc('month',acof.rpt_prd_end_dt) and tmi.fcy_num = acof.fcy_num
left join pce_qe16_prd..stg_TMP_HARM_EVENTS_FCT thef on tmi.rpt_dt = thef.rpt_dt and tmi.fcy_num = thef.fcy_num
left join pce_qe16_prd..stg_tmp_zero_events_fct tzef on tmi.rpt_dt = tzef.rpt_dt and tmi.fcy_num = tzef.fcy_num
...
--weighted_pts
--from pce_Qe16_prd..clncl_outc_scor_fct Z where rpt_dt = '2020-02-01 00:00:00' and fcy_nm ='McLaren Flint';

--select Z.fcy_nm, readm_obs_rt *100 from pce_Qe16_prd..stg_clncl_outc_scor_fct Z where rpt_dt = '2020-02-01 00:00:00';
--
-- 
-- select fcy_nm,
...
--Z.*
--from pce_Qe16_prd..clncl_outc_scor_fct Z where rpt_dt = '2020-02-01 00:00:00' and fcy_nm ='McLaren Greater Lansing';
-- select * from pce_qe16_prd..stg_mmg_ovrl_ptnt_exrnc_msr_fct LIMIT 100; 
--  select distinct rpt_dt from pce_qe16_prd..stg_tmp_mrtly_ind LIMIT 100; 
-- 
...
DROP TABLE pce_qe16_prd..tmp_lab_utlz_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..tmp_ob_trn_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..ptnt_exrnc_pct_msr_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..mmg_ovrl_ptnt_exrnc_msr_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..tmp_mmg_ovrl_ptnt_exrnc_msr_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..aco_mpp_msr_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..tmp_card_rehab_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..tmp_sep_compl_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..clncl_outc_scor_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..card_rhb_movm_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..mmg_ovrl_ptnt_exrnc_msr_mnth_over_mnth_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..ptnt_exrnc_pct_msr_fct_mnth_over_mnth_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..encntr_qs_anl_fct_vw_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..pqsd_cmplc_idnx_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..harm_events_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..tmp_harm_events_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..nhsn_zero_event_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..hac_zero_event_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..psi_zero_event_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..zero_event_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..tmp_zero_events_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..tmp_mrtly_ind_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..tmp_sep_mrtly_ind_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..tmp_readm_ind_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..lab_utlz_fct_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..tmp_mrtly_ind_wo_covid_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..tmp_sep_mrtly_ind_wo_covid_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..tmp_readm_ind_wo_covid_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..tmp_lab_utlz_fct_wo_covid_prev_run IF EXISTS;
DROP TABLE pce_qe16_prd..clncl_outc_scor_fct_wo_covid_prev_run IF EXISTS;
--Target --> _prev_Run
alter table pce_qe16_prd..encntr_qs_anl_fct_vw RENAME TO pce_qe16_prd..encntr_qs_anl_fct_vw_prev_run;
alter table pce_qe16_prd..pqsd_cmplc_idnx_fct RENAME TO pce_qe16_prd..pqsd_cmplc_idnx_fct_prev_run;
alter table pce_qe16_prd..harm_events_fct RENAME TO pce_qe16_prd..harm_events_fct_prev_run;
alter table pce_qe16_prd..TMP_HARM_EVENTS_FCT RENAME TO pce_qe16_prd..TMP_HARM_EVENTS_FCT_prev_run;
alter table pce_qe16_prd..nhsn_zero_event_fct RENAME TO pce_qe16_prd..nhsn_zero_event_fct_prev_run;
alter table pce_qe16_prd..hac_zero_event_fct RENAME TO pce_qe16_prd..hac_zero_event_fct_prev_run;
alter table pce_qe16_prd..psi_zero_event_fct RENAME TO pce_qe16_prd..psi_zero_event_fct_prev_run;
alter table pce_qe16_prd..zero_event_fct RENAME TO pce_qe16_prd..zero_event_fct_prev_run;
alter table pce_qe16_prd..TMP_ZERO_EVENTS_FCT RENAME TO pce_qe16_prd..TMP_ZERO_EVENTS_FCT_prev_run;
alter table pce_qe16_prd..tmp_mrtly_ind RENAME TO pce_qe16_prd..tmp_mrtly_ind_prev_run;
alter table pce_qe16_prd..tmp_sep_mrtly_ind RENAME TO pce_qe16_prd..tmp_sep_mrtly_ind_prev_run;
alter table pce_qe16_prd..tmp_readm_ind RENAME TO pce_qe16_prd..tmp_readm_ind_prev_run;
alter table pce_qe16_prd..lab_utlz_fct RENAME TO pce_qe16_prd..lab_utlz_fct_prev_run;
alter table pce_qe16_prd..tmp_lab_utlz_fct RENAME TO pce_qe16_prd..tmp_lab_utlz_fct_prev_run;
alter table pce_qe16_prd..tmp_ob_trn_fct RENAME TO pce_qe16_prd..tmp_ob_trn_fct_prev_run;
alter table pce_qe16_prd..ptnt_exrnc_pct_msr_fct RENAME TO pce_qe16_prd..ptnt_exrnc_pct_msr_fct_prev_run;
--alter table pce_qe16_prd..tmp_ptnt_exrnc_pct_msr_fct RENAME TO pce_qe16_prd..tmp_ptnt_exrnc_pct_msr_fct_prev_run;
alter table pce_qe16_prd..mmg_ovrl_ptnt_exrnc_msr_fct RENAME TO pce_qe16_prd..mmg_ovrl_ptnt_exrnc_msr_fct_prev_run;
alter table pce_qe16_prd..tmp_mmg_ovrl_ptnt_exrnc_msr_fct RENAME TO pce_qe16_prd..tmp_mmg_ovrl_ptnt_exrnc_msr_fct_prev_run;
alter table pce_qe16_prd..aco_mpp_msr_fct RENAME TO pce_qe16_prd..aco_mpp_msr_fct_prev_run;
alter table pce_qe16_prd..tmp_card_rehab_fct RENAME TO pce_qe16_prd..tmp_card_rehab_fct_prev_run;
alter table pce_qe16_prd..tmp_sep_compl_fct RENAME TO pce_qe16_prd..tmp_sep_compl_fct_prev_run;
alter table pce_qe16_prd..clncl_outc_scor_fct RENAME TO pce_qe16_prd..clncl_outc_scor_fct_prev_run;
alter table pce_qe16_prd..card_rhb_movm_fct RENAME TO pce_qe16_prd..card_rhb_movm_fct_prev_run;
alter table pce_qe16_prd..mmg_ovrl_ptnt_exrnc_msr_mnth_over_mnth_fct RENAME TO pce_qe16_prd..mmg_ovrl_ptnt_exrnc_msr_mnth_over_mnth_fct_prev_run;
alter table pce_qe16_prd..ptnt_exrnc_pct_msr_fct_MNTH_OVER_MNTH RENAME TO pce_qe16_prd..ptnt_exrnc_pct_msr_fct_MNTH_OVER_MNTH_prev_run;
alter table pce_qe16_prd..tmp_mrtly_ind_wo_covid RENAME TO pce_qe16_prd..tmp_mrtly_ind_wo_covid_prev_run;
alter table pce_qe16_prd..tmp_sep_mrtly_ind_wo_covid RENAME TO pce_qe16_prd..tmp_sep_mrtly_ind_wo_covid_prev_run;
alter table pce_qe16_prd..tmp_readm_ind_wo_covid RENAME TO pce_qe16_prd..tmp_readm_ind_wo_covid_prev_run;
alter table pce_qe16_prd..tmp_lab_utlz_fct_wo_covid RENAME TO pce_qe16_prd..tmp_lab_utlz_fct_wo_covid_prev_run;
alter table pce_qe16_prd..clncl_outc_scor_fct_wo_covid RENAME TO pce_qe16_prd..clncl_outc_scor_fct_wo_covid_prev_run;
----Stg --> Target
alter table pce_qe16_prd..stg_encntr_qs_anl_fct_vw  RENAME TO pce_qe16_prd..encntr_qs_anl_fct_vw;
alter table pce_qe16_prd..stg_pqsd_cmplc_idnx_fct  RENAME TO pce_qe16_prd..pqsd_cmplc_idnx_fct;
alter table pce_qe16_prd..stg_harm_events_fct  RENAME TO pce_qe16_prd..harm_events_fct;
alter table pce_qe16_prd..stg_tmp_harm_events_fct  RENAME TO pce_qe16_prd..tmp_harm_events_fct;
alter table pce_qe16_prd..stg_nhsn_zero_event_fct  RENAME TO pce_qe16_prd..nhsn_zero_event_fct;
alter table pce_qe16_prd..stg_hac_zero_event_fct  RENAME TO pce_qe16_prd..hac_zero_event_fct;
alter table pce_qe16_prd..stg_psi_zero_event_fct  RENAME TO pce_qe16_prd..psi_zero_event_fct;
alter table pce_qe16_prd..stg_zero_event_fct  RENAME TO pce_qe16_prd..zero_event_fct;
alter table pce_qe16_prd..stg_tmp_zero_events_fct  RENAME TO pce_qe16_prd..tmp_zero_events_fct;
alter table pce_qe16_prd..stg_tmp_mrtly_ind  RENAME TO pce_qe16_prd..tmp_mrtly_ind;
alter table pce_qe16_prd..stg_tmp_sep_mrtly_ind  RENAME TO pce_qe16_prd..tmp_sep_mrtly_ind;
alter table pce_qe16_prd..stg_tmp_readm_ind  RENAME TO pce_qe16_prd..tmp_readm_ind;
alter table pce_qe16_prd..stg_lab_utlz_fct  RENAME TO pce_qe16_prd..lab_utlz_fct;
alter table pce_qe16_prd..stg_tmp_lab_utlz_fct  RENAME TO pce_qe16_prd..tmp_lab_utlz_fct;
alter table pce_qe16_prd..stg_ptnt_exrnc_pct_msr_fct  RENAME TO pce_qe16_prd..ptnt_exrnc_pct_msr_fct;
--alter table pce_qe16_prd..stg_tmp_ptnt_exrnc_pct_msr_fct  RENAME TO pce_qe16_prd..tmp_ptnt_exrnc_pct_msr_fct;
alter table pce_qe16_prd..stg_mmg_ovrl_ptnt_exrnc_msr_fct  RENAME TO pce_qe16_prd..mmg_ovrl_ptnt_exrnc_msr_fct;
alter table pce_qe16_prd..stg_tmp_mmg_ovrl_ptnt_exrnc_msr_fct  RENAME TO pce_qe16_prd..tmp_mmg_ovrl_ptnt_exrnc_msr_fct;
alter table pce_qe16_prd..stg_aco_mpp_msr_fct  RENAME TO pce_qe16_prd..aco_mpp_msr_fct;
alter table pce_qe16_prd..stg_tmp_card_rehab_fct  RENAME TO pce_qe16_prd..tmp_card_rehab_fct;
alter table pce_qe16_prd..stg_tmp_ob_trn_fct  RENAME TO pce_qe16_prd..tmp_ob_trn_fct;
alter table pce_qe16_prd..stg_tmp_sep_compl_fct  RENAME TO pce_qe16_prd..tmp_sep_compl_fct;
alter table pce_qe16_prd..stg_clncl_outc_scor_fct  RENAME TO pce_qe16_prd..clncl_outc_scor_fct;
alter table pce_qe16_prd..stg_card_rhb_movm_fct  RENAME TO pce_qe16_prd..card_rhb_movm_fct;
alter table pce_qe16_prd..stg_mmg_ovrl_ptnt_exrnc_msr_mnth_over_mnth_fct  RENAME TO pce_qe16_prd..mmg_ovrl_ptnt_exrnc_msr_mnth_over_mnth_fct;
alter table pce_qe16_prd..stg_ptnt_exrnc_pct_msr_fct_mnth_over_mnth  RENAME TO pce_qe16_prd..ptnt_exrnc_pct_msr_fct_mnth_over_mnth;
alter table pce_qe16_prd..stg_clncl_outc_scor_fct_wo_covid RENAME TO pce_qe16_prd..clncl_outc_scor_fct_wo_covid;
alter table pce_qe16_prd..stg_tmp_mrtly_ind_wo_covid RENAME TO pce_qe16_prd..tmp_mrtly_ind_wo_covid;
alter table pce_qe16_prd..stg_tmp_sep_mrtly_ind_wo_covid RENAME TO pce_qe16_prd..tmp_sep_mrtly_ind_wo_covid;
alter table pce_qe16_prd..stg_tmp_readm_ind_wo_covid RENAME TO pce_qe16_prd..tmp_readm_ind_wo_covid;
alter table pce_qe16_prd..stg_tmp_lab_utlz_fct_wo_covid RENAME TO pce_qe16_prd..tmp_lab_utlz_fct_wo_covid;
