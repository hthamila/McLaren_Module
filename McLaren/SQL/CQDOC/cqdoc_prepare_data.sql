...
--******************************** CQDOC Population ******************************************
SELECT 'pce_qe16_slp_prd_dm..cqdoc_population_data' AS processing_table;
DROP TABLE pce_qe16_slp_prd_dm..cqdoc_population_data IF EXISTS;
CREATE TABLE pce_qe16_slp_prd_dm..cqdoc_population_data AS
SELECT DISTINCT
    eaf.fcy_nm,
    eaf.encntr_num,
...
FROM
    ...
    ON
        ...
        ccsr.actv_ind = 'Y'
WHERE
    (DATE(eaf.dschrg_dt) BETWEEN (DATE_TRUNC('MONTH',CURRENT_DATE) - INTERVAL '2 MONTHS') AND CURRENT_DATE) AND
...
--******************************** Encounter File ******************************************
SELECT 'pce_qe16_slp_prd_dm..cqdoc_encounter_data' AS processing_table;
DROP TABLE pce_qe16_slp_prd_dm..cqdoc_encounter_data IF EXISTS;
CREATE TABLE pce_qe16_slp_prd_dm..cqdoc_encounter_data AS
SELECT
    'MI2002' AS system_id,
...
FROM
    pce_qe16_slp_prd_dm..prd_encntr_anl_fct eaf
    INNER JOIN pce_qe16_slp_prd_dm..cqdoc_population_data pop
    ON
...
--******************************** Diagnosis File ******************************************
SELECT 'pce_qe16_slp_prd_dm..cqdoc_diagnosis_data' AS processing_table;
DROP TABLE pce_qe16_slp_prd_dm..cqdoc_diagnosis_data IF EXISTS;
CREATE TABLE pce_qe16_slp_prd_dm..cqdoc_diagnosis_data AS
SELECT
    DISTINCT
    'MI2002' AS system_id,
    CASE WHEN eaf.fin IS NULL THEN eaf.encntr_num ELSE eaf.fin ||'-'||eaf.encntr_num END AS encounter_id,
...
--******************************** CPT Procedure File ******************************************
SELECT 'pce_qe16_slp_prd_dm..intermediate_cqdoc_cpt_data' AS processing_table;
DROP TABLE pce_qe16_slp_prd_dm..intermediate_cqdoc_cpt_data IF EXISTS;
CREATE TABLE pce_qe16_slp_prd_dm..intermediate_cqdoc_cpt_data AS
SELECT
    cf.fcy_nm,
    cf.encntr_num,
    cf.cpt_code,
...
SELECT 'pce_qe16_slp_prd_dm..cqdoc_cpt_data' AS processing_table;
DROP TABLE pce_qe16_slp_prd_dm..cqdoc_cpt_data IF EXISTS;
CREATE TABLE pce_qe16_slp_prd_dm..cqdoc_cpt_data AS
SELECT
    DISTINCT
    'MI2002' AS system_id,
    CASE WHEN eaf.fin IS NULL THEN eaf.encntr_num ELSE eaf.fin ||'-'||eaf.encntr_num END AS encounter_id,
...
FROM
    ...
    (
        SELECT
            ...
            cpt_modifier_4
        FROM
            pce_qe16_slp_prd_dm..intermediate_cqdoc_cpt_data
        WHERE
...
--******************************** Patient File ******************************************
SELECT 'pce_qe16_slp_prd_dm..cqdoc_patient_data' AS processing_table;
DROP TABLE pce_qe16_slp_prd_dm..cqdoc_patient_data IF EXISTS;
CREATE TABLE pce_qe16_slp_prd_dm..cqdoc_patient_data AS
SELECT
    system_id,
    mrn,
    upi,
...
--******************************** Provider File ******************************************
SELECT 'pce_qe16_slp_prd_dm..cqdoc_provider_data' AS processing_table;
DROP TABLE pce_qe16_slp_prd_dm..cqdoc_provider_data IF EXISTS;
CREATE TABLE pce_qe16_slp_prd_dm..cqdoc_provider_data AS
SELECT
    DISTINCT
    'MI2002' AS system_id,
...
--******************************** Clinic File ******************************************
SELECT 'pce_qe16_slp_prd_dm..cqdoc_clinic_data' AS processing_table;
DROP TABLE pce_qe16_slp_prd_dm..cqdoc_clinic_data IF EXISTS;
CREATE TABLE pce_qe16_slp_prd_dm..cqdoc_clinic_data AS
SELECT
    DISTINCT
    'MI2002' AS system_id,
...
--******************************** Payor File ******************************************
SELECT 'pce_qe16_slp_prd_dm..cqdoc_payor_data' AS processing_table;
DROP TABLE pce_qe16_slp_prd_dm..cqdoc_payor_data IF EXISTS;
CREATE TABLE pce_qe16_slp_prd_dm..cqdoc_payor_data AS
SELECT
    DISTINCT
    'MI2002' AS system_id,
